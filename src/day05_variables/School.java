...
public class School {
 /*
    ...
    Task:
     ...
     declare and assign these variable
 ...
 */
    ...
    public static void main(String[] args) {
        ...
        //Students.out.println("Total Number of Students: " + numberOfStudentsInGrade1 + numberOfStudentsInGrade2); //Task will concatenate
        ...
        //variableName.soutv.
        System.out.println("Number Of Snow Days In A Year: " + numberOfSnowDaysInYear);
