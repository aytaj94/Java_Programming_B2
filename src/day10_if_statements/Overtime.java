...
public class Overtime {
    ...
    public static void main(String[] args) {
        ...
        if(numberOfHours > 40) {
            ...
            message = "You worked " + numberOfHours + " hours at a rate of " + hourlyRate + ", but " + overtimeHours +
                    " of the hours were overtime, so you got an additional pay for those hours. Your net pay was $" + netPay;
