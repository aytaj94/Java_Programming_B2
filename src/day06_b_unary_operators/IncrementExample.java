...
public class IncrementExample {
    public static void main(String[] args) {
        ...
        System.out.println(++x); //5  PRE-INCREMENT - it will update the x first and then print

        System.out.println(x++); // 5  POST-INCREMENT -it prints first and then update the x
